...
class SystemController extends PanelController
{
	...
	protected function getDatabaseInfo(): array
	{
		...
		$connectionHint .= '<span class="fw-bold">Note:</span> For optimal database performance, set <code>max_user_connections</code> between <code>30</code> and <code>100</code> to control individual user load and <code>max_connections</code> between <code>150</code> and <code>200</code> to handle overall traffic.';
		$connectionHint .= '<br><br>';
