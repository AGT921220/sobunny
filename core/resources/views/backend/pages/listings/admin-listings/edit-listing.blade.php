                                                                ...
                                                                <div class="condition">
                                                                    ...
                                                                    <div class="cs_radio_btn d-flex gap-3 conditions condition_disable_enable">
                                                                        <div class="radio d-flex align-items-center gap-2">
                                                                            <input id="condition-1" name="condition"  value="used" type="radio" tabindex="0" class="radio_disable_color" {{ $listing->condition == 'used' ? 'checked' : '' }}>
                                                                            <label for="condition-1" class="radio-label">{{ __('Used') }}</label>
                                                                        </div>
                                                                        <div class="radio d-flex align-items-center gap-2">
                                                                            <input id="condition-2" name="condition"  value="new" type="radio" tabindex="0" class="radio_disable_color" {{ $listing->condition == 'new' ? 'checked' : '' }}>
                                                            ...
                                                            <div class="form__input__single">
                                                                <div class="condition">
                                                                    ...
                                                                    <div class="cs_radio_btn d-flex gap-3 conditions authenticity_disable_enable">
                                                                        ...
                                                                        <div class="radio d-flex align-items-center gap-2">
                                                                            <input id="authenticity-2" name="authenticity"  value="refurbished" type="radio"
                                                                                   tabindex="0" class="radio_disable_color" {{ $listing->authenticity == 'refurbished' ? 'checked' : '' }}>
