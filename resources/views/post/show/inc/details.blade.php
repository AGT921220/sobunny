...
<div class="items-details">
					...
					<div class="row">
						...
						<div class="col-md-6 col-sm-6 col-6">
							<h4 class="fw-normal p-0">
								...
								<span>
									<a href="{!! \App\Services\UrlGen::city(data_get($post, 'city')) !!}">
					...
					@if (empty($authUserId) || $authUserId != data_get($post, 'user_id'))
						<div class="row text-center h2 mt-4">
							<div class="col-4">
								@if (!empty($authUser))
									@if ($authUserId == data_get($post, 'user_id'))
										<a href="{{ \App\Services\UrlGen::editPost($post) }}">
							...
							@if (isVerifiedPost($post))
								...
								<div class="col-4">
									<a href="{{ \App\Services\UrlGen::reportPost($post) }}">
	...
	<div class="content-footer text-start">
		@if (!empty($authUser))
			@if ($authUserId == data_get($post, 'user_id'))
				<a class="btn btn-default" href="{{ \App\Services\UrlGen::editPost($post) }}">
