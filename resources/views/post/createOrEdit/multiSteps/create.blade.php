                    ...
                    <div class="inner-box category-content" style="overflow: visible;">
                        ...
                        <div class="row">
                            <div class="col-xl-12">
                                ...
                                <form class="form-horizontal" id="payableForm" method="POST"
                                    ...
                                    <fieldset>
                                        ...
                                        @if (config('settings.listing_form.show_listing_type'))
                                            ...
                                            @php
                                                $postTypeIdError =
                                                    isset($errors) && $errors->has('post_type_id') ? ' is-invalid' : '';
                                        ...
                                        @php
                                            $descriptionError =
                                                isset($errors) && $errors->has('description') ? ' is-invalid' : '';
                                        ...
                                        @php
                                            $countryCodeError =
                                                isset($errors) && $errors->has('country_code') ? ' is-invalid' : '';
                                            $countryCodeValue = !empty(config('ipCountry.code'))
                                        ...
                                        @php
                                            $cityIdError =
                                                isset($errors) && $errors->has('city_id') ? ' is-invalid' : '';
                                        @endphp
										...
										<div id="cityBox" class="row mb-3 required">
                                            <label class="col-md-3 col-form-label" >
                                                Aditional Cities <sup>*</sup>
                                            </label>
                                            <div class="col-md-8">
												<select class="form-control select2 aditional_cities" name="cities[]"
													multiple="multiple" data-max-options="2">
												</select>
                                            </div>
                                        </div>
                                        ...
                                        {{-- <div class="form-group">
											                                                    ...
											                                                    @foreach ($cities as $manejo)
                                                        <option value="{{ $manejo->id }}">{{ $manejo->name }}</option>
                                                    @endforeach

                                            <div class="col-md-12">
                                                <label>Aditional Cities</label>
                                                <select class="form-control select2-multiple cities" name="cities[]"
                                                    multiple="multiple">
                                        ...
                                        @else
                                            @php
                                                $isPermanentError =
                                                    isset($errors) && $errors->has('is_permanent') ? ' is-invalid' : '';
                                            @endphp
                                                ...
                                                <div class="col-md-8">
                                                    <div class="form-check">
                                                        <input id="isPermanent" name="is_permanent"
                                                            ...
                                                            value="1" type="checkbox" @checked(old('is_permanent', data_get($postInput, 'is_permanent')) == '1')>
                                        ...
                                        @php
                                            $contactNameError =
                                                isset($errors) && $errors->has('contact_name') ? ' is-invalid' : '';
                                        @endphp
                                        @if (auth()->check())
                                        ...
                                        @php
                                            ...
                                            $authFieldError =
                                                isset($errors) && $errors->has('auth_field') ? ' is-invalid' : '';
                                            $usersCanChooseNotifyChannel = isUsersCanChooseNotifyChannel();
                                            $authFieldValue = $usersCanChooseNotifyChannel
                                                ? old('auth_field', getAuthField())
                                                : getAuthField();
                                        @endphp
                                        ...
                                        @php
                                            $forceToDisplay = isBothAuthFieldsCanBeDisplayed()
                                                ? ' force-to-display'
                                                : '';
                                        @endphp
                                        ...
                                        @php
                                            ...
                                            $phoneValueOld = phoneE164(
                                                old('phone', $phoneValue),
                                                old('phone_country', $phoneCountryValue),
                                            );
                                        @endphp
                                        <div class="row mb-3 auth-field-item required{{ $forceToDisplay }}">
                                                ...
                                                <div class="input-group{{ $phoneError }}">
                                                    ...
                                                    <span class="input-group-text iti-group-text">
                                                        <input id="phoneHidden" name="phone_hidden" type="checkbox"
                                                            value="1"
                                                            @checked(old('phone_hidden') == '1')>&nbsp;<small>{{ t('Hide') }}</small>
                                                    </span>
                                                </div>
                                                ...
                                                @if (config('settings.listing_form.auto_registration') == 1)
                                                    @php
                                                        $autoRegistrationError =
                                                            isset($errors) && $errors->has('auto_registration')
                                                                ? ' is-invalid'
                                                                : '';
                                                    @endphp
                                                    <div class="row mb-3 required">
                                        ...
                                        @if (!auth()->check())
                                            ...
                                            @php
                                                $acceptTermsError =
                                                    isset($errors) && $errors->has('accept_terms') ? ' is-invalid' : '';
                                                $acceptTerms = old(
                                                    'accept_terms',
                                                    data_get($postInput, 'accept_terms'),
                                                );
                                            @endphp
                                            <div class="row mb-3 required">
                                                <label class="col-md-3 col-form-label"></label>
                                                <div class="col-md-8">
                                                    <div class="form-check">
                                                        <input name="accept_terms" id="acceptTerms"
                                                            ...
                                                            value="1" type="checkbox" @checked($acceptTerms == '1')>
                                            ...
                                            @php
                                                $acceptMarketingOffersError =
                                                    isset($errors) && $errors->has('accept_marketing_offers')
                                                        ? ' is-invalid'
                                                        : '';
                                                $acceptMarketingOffers = old(
                                                    'accept_marketing_offers',
                                                ...
                                                <div class="col-md-8">
                                                    <div class="form-check">
                                                        <input name="accept_marketing_offers" id="acceptMarketingOffers"
                                                            ...
                                                            value="1" type="checkbox" @checked($acceptMarketingOffers == '1')>
